"""
Django settings for blogsley project.
...
ALLOWED_HOSTS = ["web", "localhost"] if os.environ.get("NODEBUG") is None else ["blogsley.kfields.me"]
...
CORS_ORIGIN_WHITELIST = (
    'mc.blogsley.kfields.me',
    'blogsleymc.netlify.com',
    'localhost:8080'
)

ROOT_URLCONF = 'blogsley.urls'
...
WSGI_APPLICATION = 'blogsley.wsgi.application'
...
WAGTAIL_SITE_NAME = 'blogsley'
HOSTNAME = 'blogsley.kfields.me'

CRISPY_TEMPLATE_PACK = 'bootstrap4'

GRAPHENE = {
    'SCHEMA': 'blogsley.schema.schema'
}
